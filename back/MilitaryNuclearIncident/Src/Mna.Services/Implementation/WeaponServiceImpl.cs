...
{
    public class WeaponServiceImpl(BrokenArrowContext context, IMapper mapper, ILogger<WeaponServiceImpl> logger) : IWeaponService
    {
        ...
        public async Task<IEnumerable<WeaponResponse>> GetWeaponsAsync()
        {
            ...
            catch (DbException ex)
            {
                ...
                throw new MilitaryNuclearAccidentException(ConstUtils.UNABLE_TO_RETRIEVE_ALL_WEAPON, ex);
            }
        }
        ...
        public async Task<WeaponResponse?> GetSingleWeaponAsync(Guid weaponId)
        {
            ...
            {
                _logger.LogError(ex, ConstUtils.ERROR_LOG_WEAPON);
                throw new MilitaryNuclearAccidentException(ConstUtils.UNABLE_TO_RETRIEVE_SPECIFIC_WEAPON, ex);
            }
        }
